 ...
 * @version $Id: XMLDocument.java,v 1.1 2009/12/19 18:46:58 msr Exp $
 */
public class XMLDocument extends PlainDocument {
     ...
     * @throws javax.swing.text.BadLocationException if fromIndex was not a valid part of the document
     */
